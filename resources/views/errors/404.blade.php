...
<body class="min-h-screen bg-gradient-to-br from-slate-50 to-emerald-50 antialiased text-slate-900" style="font-family: 'Inter', sans-serif;">
    <div class="relative isolate flex min-h-screen items-center justify-center overflow-hidden px-4 py-10 sm:px-6 lg:px-8">
        <div class="w-full max-w-4xl">
            <div class="text-center">
                ...
                <p class="mt-4 text-xs font-semibold uppercase tracking-[0.35em] text-emerald-600">{{ config('app.name', 'StocKita') }}</p>
            </div>

            <div class="text-center">
                <h1 class="mt-3 bg-gradient-to-r from-emerald-600 to-teal-600 bg-clip-text text-[8rem] font-extrabold leading-none text-transparent sm:text-3xl lg:text-7xl">404</h1>
            ...
            <div class="mx-auto mt-10 flex w-full max-w-xl flex-col gap-3 sm:flex-row">
                <a href="{{ url('/') }}"
                    class="inline-flex w-full items-center justify-center rounded-2xl bg-emerald-500 px-5 py-3 text-sm font-semibold text-white transition-all hover:-translate-y-0.5 hover:bg-emerald-600">
                    Go to Home
                </a>
