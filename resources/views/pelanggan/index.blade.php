                    ...
                    <div x-data class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
                        ...
                        <div class="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 w-full lg:w-auto">
                            ...
                            <a href="{{ route('customers.export', request()->query()) }}"
                                class="px-4 py-2.5 bg-primary-600 hover:bg-primary-700 text-white rounded-xl text-sm font-medium flex items-center gap-2 whitespace-nowrap transition">
                            ...
                            <button type="button" @click="$dispatch('open-modal', { name: 'create-customer' })"
                                class="px-4 py-2.5 bg-primary-500 hover:bg-primary-600 text-white rounded-xl text-sm font-semibold flex items-center gap-2 whitespace-nowrap shadow transition">
                                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        ...
                        <tr x-data>
                            <td colspan="5" class="px-6 py-12 text-center text-gray-500">
                                ...
                                <button @click="$dispatch('open-modal', { name: 'create-customer' })"
                                    class="px-4 py-2 text-white rounded-lg font-medium bg-primary-500 hover:bg-primary-600">
                                    + Add Customer
                                </button>
                            </td>
                        </tr>
