<x-app-layout title="Order Details">
    <div class="py-6 space-y-6 mx-auto">
        ...
        <div class="bg-white p-8 rounded-3xl shadow-lg border border-gray-100">
            <div class="flex justify-between items-start md:items-center flex-wrap gap-4">
                ...
                <span
                    ...
                    {{ $order->status == 'paid' ? 'bg-primary-50 text-primary-700 border-primary-200' : 'bg-yellow-50 text-yellow-700 border-yellow-200' }}">
        ...
        <div class="bg-gradient-to-r from-primary-50 to-primary-50 p-8 rounded-3xl shadow-lg border border-primary-100">
            <h2 class="text-xl font-bold text-gray-900 mb-6 flex items-center gap-2">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="currentColor" class="size-6 text-primary-600">
            ...
            <div class="bg-white/50 backdrop-blur-sm p-6 rounded-2xl border border-white/50 space-y-4">
                <div class="flex justify-between py-3 border-b border-primary-100">
                    <span class="text-gray-700 font-medium">Total Purchase</span>
                ...
                <div class="flex justify-between items-end py-4 pt-6">
                    <div>
                        <span class="text-sm text-gray-600 block mb-1">Change</span>
                        @if ($order->change > 0)
                    ...
                    <div class="flex flex-col items-end gap-2">
                        <span class="text-xs text-gray-500 text-right">Payment Receipt</span>
                        <div class="w-24 h-24 bg-white rounded-xl shadow-sm overflow-hidden border">
                            <img src="{{ asset('storage/' . $order->receipt) }}" alt="Payment Receipt"
